...
export class RegiaoUserService {
  ...
  constructor(private http: HttpClient) { }
    ...
    getRegioesByRegiaoMestre(id): Observable<any> {
        const httpOptions = {
            headers: new HttpHeaders({
                'Accept':  'application/json',
                'authorization': 'Basic ' + this.token
        ...
        return this.http.get(this.url + '/regiao-insert-custom/regiao-mestre/' + id ,  httpOptions);
    }
    ...
    updateRegiaoDelete(payload): Observable<any> {
        const httpOptions = {
            headers: new HttpHeaders({
                'Accept':  'application/json',
                'authorization': 'Basic ' + this.token
        ...
        return this.http.put(this.url + '/regiao-insert-custom/status' , payload, httpOptions);
    }
    ...
    deleteRegiaoPublicada(id): Observable<any> {
        const httpOptions = {
            headers: new HttpHeaders({
                'Accept': 'application/json',
                'authorization': 'Basic ' + this.token
        ...
        return this.http.delete(this.url + '/regiao-insert-custom/publicada/' + id , httpOptions);
    }
