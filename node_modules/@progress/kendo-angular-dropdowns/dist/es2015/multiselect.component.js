...
export class MultiSelectComponent {
    ...
    setState(value) {
        ...
        if (!this.text) {
            ...
            const allItems = this.selectedDataItems.concat(this.data);
            const prop = this.prop(this.valueField, this.valuePrimitive);
            this.selectedDataItems = allItems.filter(curr => this.value.find(item => prop(item) === prop(curr))).filter(dataItem => !!dataItem); // filter undefined values
        }
