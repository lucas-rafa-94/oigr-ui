...
/**
 * Used for rendering the selected tag value. The directive
 * can only be used with the MultiSelect. The template context is set to
 * the current MultiSelect. To get a reference to the current data item, use the `let-dataItem` directive.
 *
