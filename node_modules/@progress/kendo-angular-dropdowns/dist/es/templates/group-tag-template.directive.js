...
/**
 * Used for rendering the grouped tag values. The directive can only be used with the MultiSelect component.
 * The template context is set to the current MultiSelect component. To get a reference to the current grouped
